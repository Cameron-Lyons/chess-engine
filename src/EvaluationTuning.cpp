...
namespace EvaluationParams {
    ...
    // ===================================================================
    // These are based on analysis of top engines like Stockfish, Komodo,
    // and Leela Chess Zero, with adjustments for tactical play
    
    const int TUNED_PAWN_MG[64] = {
         0,   0,   0,   0,   0,   0,   0,   0,
        78,  83,  86,  73, 102,  82,  85,  90,
         7,  29,  21,  44,  40,  31,  44,   7,
       -17,  16,  -2,  15,  14,   0,  15, -13,
       -26,   3,  10,  20,  16,   2,   0, -23,
       -22,   9,   5, -11, -10,  -2,   3, -19,
    ...
    int getMaterialValue(ChessPieceType piece) {
        switch (piece) {
            case ChessPieceType::PAWN:   return PAWN_VALUE;
            case ChessPieceType::KNIGHT: return KNIGHT_VALUE;
            case ChessPieceType::BISHOP: return BISHOP_VALUE;
            case ChessPieceType::ROOK:   return ROOK_VALUE;
            case ChessPieceType::QUEEN:  return QUEEN_VALUE;
            case ChessPieceType::KING:   return KING_VALUE;
            default: return 0;
        }
    }
    ...
    int interpolatePhase(int mgScore, int egScore, int phase) {
        // Phase goes from 0 (endgame) to TOTAL_PHASE (opening)
