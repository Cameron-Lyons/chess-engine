...
public:
    ...
    void printReport() const {
        ...
        std::cout << std::left << std::setw(30) << "Function" << std::right << std::setw(10)
                  << "Calls" << std::setw(12) << "Total (ms)" << std::setw(12) << "Avg (µs)"
                  << std::setw(15) << "Nodes" << std::setw(15) << "NPS (M/s)" << std::setw(8) << "%"
                  << "\n";
        ...
        for (const auto& [name, data] : sortedProfiles) {
            ...
            std::cout << std::left << std::setw(30) << name << std::right << std::setw(10)
                      << data.callCount << std::setw(12) << std::fixed << std::setprecision(2)
                      << totalMs << std::setw(12) << std::fixed << std::setprecision(2) << avgUs
                      << std::setw(15) << data.nodes << std::setw(15) << std::fixed
                      << std::setprecision(2) << nps << std::setw(7) << std::fixed
